...
from Speech_to_Text import sundayResponse
from Speech_to_Text import myCommand
from Text_to_speech import Text_to_sp
...
def chatbot(net, sess, chars, vocab, max_length, beam_width, relevance, temperature, topn, convertTuple):
    user_command_entered = ()
    states = initial_state_with_relevance_masking(net, sess, relevance)
    while True:
        user_input = myCommand(user_command_entered)
